...
hash_data = hashlib.md5(bytes(accountSid+authToken+batch,encoding="utf-8"))
...
print(str(authen,encoding='utf-8'))
header = {'Accept':'application/json','Content-Type':'application/x-www-form-urlencode;charset=uft-8','Authorization':str(authen,encoding='utf-8')}
