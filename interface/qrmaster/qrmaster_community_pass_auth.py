...
cookies_b = {"mz_UCLBRTUID":"0a2c9f6f-61e6-4860-b80b-6565969b6695",
           ...
           "qrm_community_identity":"dbGoWQVW0xkO7lX9",
...
req_b = requests.post("http://115.29.142.212:8021/Bpass/ComAuthority/companyStatus/id/573/userloginID/2414.html",data=data,cookies=cookies_b)
print(req_b.text)
